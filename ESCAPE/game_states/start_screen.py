...
from ESCAPE.sprites.buttom_sprite import ButtomSprite
...
class StartScreen(BaseGameStates):
    def __init__(self, game):
        ...
        self.buttom_group = pygame.sprite.Group()
...
<<<<<<< HEAD
        ...
        ButtomSprite(self,200,200,(300,50),'Начать')
        ButtomSprite(self,200,300,(300,50),'Титры')
    ...
    def render(self):
        ...
        self.crystal_group.draw(self.game.screen)
        self.crystal_group.update()
        self.buttom_group.draw(self.game.screen)
=======
        CrystalSprite(self, 400, 450, size=(250, 250), angle=30)
        CrystalSprite(self, 500, -50, angle=180, size=(250, 250))
        CrystalSprite(self, -80, -50, angle=200, size=(180, 180))
    ...
    def render(self):
        ...
        self.crystal_group.update()
        self.buttom_group.draw(self.screen)
>>>>>>> KEZKA
